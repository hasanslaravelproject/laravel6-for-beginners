        ...
        foreach($carts as $item){
            ...
            <td>
                <div class="form-group">
                    <div class="input-group">
                     <span class="input-group-addon btn btn-info exc-qty"  data-row_id="'. $item->rowId .'" data-product_id="'. $item->id .'"><i class="fa fa-minus"></i></span>
                    <input type="text" class="form-inline text-center qty current-qty_'.$item->id.' "  data-row_id="'. $item->rowId .'" data-product_id="'. $item->id .'" style="width:70px" value="'. $item->qty .'">
                       <span class="input-group-addon btn btn-info inc-qty"  data-row_id="'. $item->rowId .'" data-product_id="'. $item->id .'"><i class="fa fa-plus"></i></span>
                        </div>
                </div>
              </td>
...
return view('Cart.checkout',compact('myusers'));
   }
}
